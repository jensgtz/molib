...
model SingleLayerConstruction
  //parameters
  parameter Real A = 1 "area [m2]";
  parameter Real Azimut = 0 "azimuth [deg]";
  parameter Real Slope = 90 "slope [deg]";
  parameter Real R_cond = 1 "konduktiver Widerstand [(m2*K)/W]";
  parameter Real Cp_a = 1 "flaechenspezifische thermische Kapazitaet / area specific thermal heat capacity [J/(m2*K)]";
